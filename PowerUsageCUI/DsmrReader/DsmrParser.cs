...
namespace PowerUsageCUI.DsmrReader
{
    ...
    public class DsmrParser : IDsmrParser
    {
        ...
        private static Encoding TelegramEncoding => Encoding.UTF8;

        // Default characters used in P1 telegram
        ...
        /// <summary>
        /// Convert P1 telegram string to P1 telegram object(s) in a list.
        /// </summary>
        ...
        /// <summary>
        /// Parse P1 telegram based on a stream. Events will be used in stand of result value
        /// </summary>
        /// <param name="stream"></param>
        /// <param name="onParsedEvent"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Parse P1 telegram based on a StringReader. Delegate will be used for callback.
        /// Underwater also called with the normal string "Parse" method.
        /// </summary>
        ...
        /// <summary>
        /// Get all the properties of a telegram. USed with reflection to decode.
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Get a specific property from the telegram. Used with decoding using reflection
        /// </summary>
